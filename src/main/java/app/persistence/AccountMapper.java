...
public class AccountMapper {
    ...
    public static Account getAccountByEmail(String email, ConnectionPool connectionPool) throws AccountException {
        Account account = null;
        String sql = "SELECT account_id, name, address, zip, phone, email, role FROM accounts WHERE email = ?";
        try (Connection connection = connectionPool.getConnection();
             PreparedStatement ps = connection.prepareStatement(sql)) {
    ...
    public static String getPasswordByEmail(String email, ConnectionPool connectionPool) throws AccountException {
        ...
        String sql = "SELECT autogenerated_password FROM accounts WHERE email = ?";
        try (Connection connection = connectionPool.getConnection();
             PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    password = rs.getString("autogenerated_password");
                }
            }
        } catch (SQLException e) {
